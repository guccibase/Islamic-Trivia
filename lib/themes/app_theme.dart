...
class AppTheme {
  static final int themeLight = 0;
  static final int themeDark = 1;
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      canvasColor: Colors.transparent,
      primaryColor: Color(0xff3d63ff),
      scaffoldBackgroundColor: Color(0xff0F1733),
      backgroundColor: Color(0xff0F1733),
      ...
      bottomAppBarTheme:
      BottomAppBarTheme(color: Color(0xff2D2E2F), elevation: 2),
      tabBarTheme: TabBarTheme(
        unselectedLabelColor: Color(0xff495057),
        labelColor: Color(0xff3d63ff),
        indicatorSize: TabBarIndicatorSize.label,
